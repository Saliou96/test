        ...
        <div class="row" style="margin: 0% 0% 0% 1%">
            <div class="col-md-2">
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingInputGrid" name="new_firstname" value="{{ $client->firstname }}">
                    <label for="floatingInputGrid">FirstName</label>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingInputGrid" name="new_lastname" value="{{ $client->lastname }}">
